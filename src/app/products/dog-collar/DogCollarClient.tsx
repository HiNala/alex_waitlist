      ...
      <section className="relative h-[500px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center p-6">
          <div className="max-w-2xl">
            <h2 className="font-serif text-4xl sm:text-5xl text-white mb-4">Built for every adventure</h2>
            <p className="text-lg sm:text-xl text-white/90 font-sans">
              Waterproof, durable, and designed to keep up with even the most active dogs.
            </p>
          </div>
        </div>
      </section>
